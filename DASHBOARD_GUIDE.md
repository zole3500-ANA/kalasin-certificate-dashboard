...
- ระบบอัปเดตอัตโนมัติ: GitHub Actions ทุก 30 นาที ที่นาที `17` และ `47` ของทุกชั่วโมง
...
- อัตโนมัติทุก 30 นาที ด้วย cron `17,47 * * * *`
...
2. รอรอบอัปเดตถัดไป ประมาณ 30 นาที
...
### Workflow ไม่ทำงานตรงทุก 30 นาที

ตารางตั้งไว้ทุก 30 นาทีแล้วที่ `17` และ `47` แต่ GitHub อาจหน่วงเวลาเริ่มงานได้ หากต้องการให้ข้อมูลเปลี่ยนทันที ให้กดรัน workflow เอง
